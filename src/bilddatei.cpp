...
void Bilddatei::bildNachbearbeiten() {
  ...
  if (mGefaerbt) {
    ...
    bool gleich = (src!=mBildOriginal->mBild);
	 ...
	 kann direkt src gef�rbt werden, d. h.
	 dst der F�rbung = src der F�rbung. */
