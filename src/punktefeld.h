...
/** Zeigt die Punkte eines Spielers h�bsch an. Achtung: Erst _nach_
    ld-Datei-Laden erzeugen. (Weil erst dann die n�tigen Bildchen
    geladen werden.) */
class Punktefeld {
public:
  Punktefeld();
...
private:
  ...
  /** True, wenn sich was ge�ndert hat, d. h. wenn der Bildschirminhalt
      nicht aktuell ist */
  bool mUpdateNoetig;
